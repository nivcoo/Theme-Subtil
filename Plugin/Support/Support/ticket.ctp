...
<div class="jumbotron jumbotron-fluid text-center">
	<div class="container">
	        <h1 class="display-3 title"><?= $Lang->get('SUPPORT__PROBLEMQUESTION', ['{ID_TICKET}' => $ticket['Ticket']['id']]) ?> <?= $Support->getUser('pseudo', $ticket['Ticket']['author']); ?></h1>
            <p class="lead"><?= $Lang->get('SUPPORT__IN_A_CATEGORIE', ['{NAME}' => $Support->getCategorie($ticket['Ticket']['categorie'])]); ?></p>
