			...
			<div class="card-body">
				<form class="form-horizontal" method="POST" data-ajax="true"
					...
					<div class="row">
						...
						<div class="col-lg-6">
							<div class="text-center"><h6><a data-dismiss="modal" href="#" data-toggle="modal"
															data-target="#lostpasswd"><?= $Lang->
								get('USER__PASSWORD_FORGOT_LABEL') ?></a></h6></div>
						</div>
					</div>
			</div>
...
<div class="modal modal-medium fade" id="lostpasswd" tabindex="-1" role="dialog" aria-labelledby="lostpasswdLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="card-footer">
        <button type="submit" class="btn btn-info btn-block"><?= $Lang->get('USER__PASSWORD_FORGOT_SEND_MAIL') ?></button>
      </form>
      </div>
    </div>
  </div>
