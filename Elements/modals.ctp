        ...
        <div class="modal-content">
            ...
            <form id="login-before-two-factor-auth" method="POST" data-ajax="true"
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="row" style="margin-left: 1px;margin-right: -1px;">
                            ...
                            <button class="unmask btn btn-secondary w-25" type="button"
                ...
                <div class="modal-footer">
                    <button type="submit" class="btn btn-info btn-block"><?= $Lang->get('USER__LOGIN') ?></button>
                </div>
            </form>
...
<div class="modal modal-medium fade" id="lostpasswd" tabindex="-1" role="dialog" aria-labelledby="lostpasswdLabel"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="card-footer">
                <button type="submit"
                        class="btn btn-info btn-block"><?= $Lang->get('USER__PASSWORD_FORGOT_SEND_MAIL') ?></button>
                </form>
            </div>
        </div>
    </div>
    ...
    <div class="modal modal-medium fade" id="lostpasswd2" tabindex="-1" role="dialog" aria-labelledby="lostpasswd2Label"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="card-body">
                    <form class="form-horizontal" method="POST" data-ajax="true"
                          action="<?= $this->Html->url(array('plugin' => null, 'admin' => false, 'controller' => 'user', 'action' => 'ajax_resetpasswd')) ?>"
                          data-redirect-url="?">
...
<div class="modal fade" id="register" tabindex="-1" role="dialog" aria-labelledby="registerLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="card-footer">
                <button type="submit" class="btn btn-info btn-block"><?= $Lang->get('USER__REGISTER') ?></button>
                </form>
            </div>
        </div>
    </div>
